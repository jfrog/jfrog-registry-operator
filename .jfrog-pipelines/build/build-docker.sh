...
source "${PROJECT_ROOT_DIR}/.jfrog-pipelines/build/ci/scripts/lib/commonUtils.sh"
source "${PROJECT_ROOT_DIR}/.jfrog-pipelines/build/ci/scripts/lib/mavenUtils.sh"
source "${PROJECT_ROOT_DIR}/.jfrog-pipelines/build/ci/scripts/lib/dockerUtils.sh"
source "${PROJECT_ROOT_DIR}/.jfrog-pipelines/build/ci/scripts/lib/pipelineUtils.sh"
...
UBI_MICRO_VERSION="9.2.13"
UBI_MINIMAL_VERSION="9.2.717"
